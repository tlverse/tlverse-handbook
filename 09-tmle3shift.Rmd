...
```{r fit_tmle-shift, message=FALSE, warning=FALSE}
...
```{r fit_tmle_wrapper_vimshift, message=FALSE, warning=FALSE}
tmle_fit <- tmle3(tmle_spec, data, node_list, learner_list)
tmle_fit
```
...
```{r vim_targeted_msm_fit, message=FALSE, warning=FALSE}
# initialize a tmle specification
...
```{r load_washb_data_shift, message=FALSE, warning=FALSE}
