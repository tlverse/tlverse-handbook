...
in the task. The default cross-validation scheme is V-fold, with the number of folds
$V=10$.
...
them as base learners in our super learner, analagous to what we have seen before. 
Now however, our learners will be preceded by a screening step.
Let's also consider the `new_stack`,
