...
function based tool that uses cross-validation to obtain an estimator for a
desired prediction function (which may be a component of our target estimand),
