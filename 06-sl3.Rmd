...
1. Select an objective function that aligns with both the purpose of your 
...
2. Assemble a diverse library of learners to be considered in the Super Learner 
   ensemble.
3. Customize a learner by modifying it's tuning parameters.
4. Create several different versions of the same learner by specifying a grid 
   of tuning parameters.
4. Create covariate screening pipelines in order to pass a screener's output, 
...
7. Interpret the fit for discrete and continuous Super Learner's from the 
   cross-validated risk table and the coefficients.
1. learners in the SL library and should be justified in terms of the prediction 
