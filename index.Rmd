...
This is an open-source and fully-reproducible electronic handbook for applying
the targeted learning methodology in practice using the [`tlverse` software
...
targeted learning, the \texttt{tlverse}. For more information, see Mark's lab
website: https://vanderlaan-lab.org.
...
the supervision of Alan Hubbard.
...
testing, and reproducible coding practices. For more information, see Nima's
