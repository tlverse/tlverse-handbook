...
::: {.proposition name = "Exchangeability"}
...
::: {.proposition name = "Treatment positivity"}
...
::: {.proposition name = "Mediator positivity"}
...
::: {.proposition name = "Cross-world counterfactual independence"}
...
::: {.exercise name = "Estimating the Natural Direct and Indirect Effects"}
...
::: {.exercise name = "The Natural Effects and the Average Treatment Effect"}
...
::: {.exercise name = "Real-world Identification of the Natural Effects"}
