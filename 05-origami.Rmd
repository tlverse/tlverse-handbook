...
<!--
RP:
if we want to introduce "true risk" then it needs to be defined. also i am not 
...
different readers if we don't define it.
-->
...
<!--
RP:
cross-validation doesn't directly estimate anything
-->
...
clarify. We delve into this in the later sections so I think "saving this for later"
is OK
-->
The `origami` package
