...
1. Understand and describe the essential properties of stochastic treatment
   ...
   treatment regimes?
2. Appreciate and overcome the challenges associated with using stochastic
   treatment regimes to construct estimates of causal effects in practice.
3. Utilize marginal structural models to construct variable importance measures
   in terms of stochastic interventions.
4. Use the `tmle3shift` R package to successfully estimate the causal effects
   of a shift-based stochastic treatment regime on simple, simulated data.
5. Perform hands-on, real-world data analysis to assess the causal effect of
...
Using the efficient influence function, a few different varieties of
...
@diaz2011super, in which arbitrary regression functions may be used to generate
...
conditional density regression techniques.
