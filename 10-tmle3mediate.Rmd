...
```{r tmle3mediate-load-data, message=FALSE, warning=FALSE}
library(data.table)
library(tidyverse)
library(sl3)
library(tmle3)
...
```{r tmle3mediate-sl-learners, message=FALSE, warning=FALSE}
...
```{r tmle3mediate-NIE, message=FALSE, warning=FALSE}
...
```{r tmle3mediate-NDE, message=FALSE, warning=FALSE}
...
```{r tmle3mediate-pide-decomp, message=FALSE, warning=FALSE}
...
`r washb_pie_decomp$summary$tmle_est - mean(washb_data[, get(node_list$Y)])`.
