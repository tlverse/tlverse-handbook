...
them as base learners in our super learner. Let's also consider the `new_stack`,
just to compare how the feature selection methods perform in comparison to the
...
very time consuming. The default in `sl3` is [TODO].
